...
@NgModule({
  declarations: [AppComponent, AddCategoryComponent, HomepageComponent, AddCardComponent, AddBookComponent, CategoryIndexComponent, EditBookComponent, BookIndexComponent, StudentIndexComponent, ExportComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    HttpClientModule,
